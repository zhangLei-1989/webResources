<template>
  <div class="popRole" ref="parents" v-if="isDelete">
    <!-- 背景层 -->
    <div class="mark"></div>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="messageval">
          <textarea placeholder="输入原因(选填)" v-model="deleteObj.remarks"></textarea>
        </div>
      </div>
...
<script>
  export default {
    ...
    methods: {
      button_click () {
       // console.info('this.deleteObj', this.deleteObj);
        let _this = this;
        _this.axios({
          method: 'post',
          url: _this.$store.state.api.message.get_message_batchDelete,

<template>
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-select v-if="scope.row.status!=6 && scope.row.status!=5" v-model="scope.row.selectedIndex" @change="changeSelected(scope.$index)" placeholder="操作">
                ...
                <el-option v-show="isButtonAuthor('500c33beb1e04b0b9e6db30e4771932e')" label="终止合同" value="1"></el-option>
                <el-option v-show="isButtonAuthor('da78711bfd9c4040aa34e137a5b84ac5')" label="标记违约" value="2"></el-option>
              </el-select>
    ...
    <el-dialog
      ...
      <template v-if="dialog.detail_msg.state!=6 && dialog.detail_msg.state!=5" slot="footer">
        <el-button type="primary" v-show="isButtonAuthor('da78711bfd9c4040aa34e137a5b84ac5')" style="width:auto;border-radius:4px;" @click="openBreach">标记违约</el-button>
        <el-button type="primary" v-show="isButtonAuthor('500c33beb1e04b0b9e6db30e4771932e')" style="width:auto;border-radius:4px;" @click="openEnd">终止合同</el-button>
      </template>
    </el-dialog>
    <el-dialog
      title="终止合同"

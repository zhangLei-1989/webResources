...
if (process.env.NODE_ENV == 'production') {
    // server_address = 'http://finance.chunhui.efanghang.com'  //正式服务器地址
  //server_address = 'http://test.finance.chunhui.efanghang.com'  //测试服务器地址
} else {
  //server_address = 'http://192.168.106.118:52011' //财务测试地址
}
server_address = 'http://finance.chunhui.efanghang.com'  //正式服务器地址
/*server_address = 'http://test.finance.chunhui.efanghang.com:52011'*/ // 本地调试地址需要加端口号
//服务器api地址
const api = {
    ...
    contract: {  //合同
        getList: "/v2/contract/contract/get_listbycheck",  //获取合同列表(审核)
    ...
    basePartner: {  //合作方
        ...
        delete:'/v2/base/base_partner/delete_by_id',  //删除合作方
        partnersDetail:'/v2/base/base_partner/get_by_id', //查看详情
        cooperationHouse:'/v2/base/base_partner/cooperation_house',//获取合作中的房源数
    },
    finance: { // 财务配置
    ...
    picture: {  //获取文件
        ...
        uploadImg:'/UploadHouseServlet?server=upload&',
        picIpStr: '/uploadPic/jinRong_qita_pic.html?id='
    },
    financeBill: {  //工作台
        getWorkSpacetopData: '/v2/balance/finance_bill/getworkspacetopdata',  //获取顶部统计数据
        getWorkSpacewaitingData: '/v2/balance/finance_bill/getworkspacewaitingdata',  //获取待处理数据
        getWorkSpacechartData: "/v2/balance/finance_bill/getworkspacechartdata"  //获取利息数据
    }

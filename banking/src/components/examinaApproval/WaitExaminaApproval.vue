<template>
    ...
    <el-dialog
      ...
      <template slot="footer">
        <el-button type="danger" v-show="isButtonAuthor('e44663c4c1464491b1d8d639a21cc02e')" style="background-color:#f2082e !important;border-color:#f2082e !important;" @click="openReject(dialog.detail_msg.id)">驳回</el-button>
        <el-button type="primary" v-show="isButtonAuthor('faed81c4680945ad8a17d7f914cd04b6')" style="width:auto;border-radius:4px;" @click="openAdopt(dialog.detail_msg.id)">通过</el-button>
      </template>
    </el-dialog>
    <el-dialog
      title="驳回审核"

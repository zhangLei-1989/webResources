        ...
        <el-table :data="table.tbody" stripe @row-click="tableRowClick">
          <el-table-column
            ...
            <template slot-scope="scope">
                <span class="finance-state">已生成合同</span>
            </template>
          </el-table-column>
          <el-table-column
            label="借款人/金额/用款时间">
        ...
        <el-col :span="24">
          ...
          <el-row>
            ...
            <el-col :span="8">
              ...
              <span class="detail-item green">已通过</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
          ...
          <el-row>
            <el-col :span="8">
              ...
              <span class="detail-item" v-text="dialog.detail_msg.contractCtName"></span>
            </el-col>
            <el-col :span="8">
              <span class="detail-title">生成时间</span>
              <span class="detail-item" v-text="dialog.detail_msg.contractCt"></span>
            </el-col>
            <el-col :span="8">
              <span class="detail-title">合同编码</span>
              <span class="detail-item" v-text="dialog.detail_msg.contractNo"></span>
            </el-col>
          </el-row>
        </el-col>
      </el-row>
        ...
        .then(response => {
          ...
          if (data.status.code == 200) {
            ...
            var detail_msg = {
              ...
              contractCt: borroJsonObject.contractCt, //合同创建时间
              contractCtName: borroJsonObject.contractCtName, //合同创建人姓名
              contractNo: borroJsonObject.contractNo //合同号
            };
            this.imgList = [];

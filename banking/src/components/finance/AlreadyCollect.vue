    ...
    <el-dialog
      ...
      <div class="waitBack_item sureBox">
        ...
        <el-row>
          ...
          <el-col :span="5" class="item_content">{{dialogData.financeBill.confirmUser}}</el-col>
      ...
      <div class="image_box">
        <see-box>
          <see-item v-for="(item,index) in  dialogData.pictrues" :key="index" :url="item.smallImgrul" :width="item.w"
                    :height="item.h">
          </see-item>
        </see-box>
      </div>

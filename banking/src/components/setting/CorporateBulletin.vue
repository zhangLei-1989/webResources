      ...
      <el-col :span="24">
        <el-form :inline="true" class="demo-form-inline" style="display:flex;">
          <el-form-item class="noMarginRight noMarginBottom" style="flex:1;padding-right:0px;">
            <el-input v-model="seachForm.titleLikeName" placeholder="公告标题"></el-input>
          </el-form-item>
    ...
    <div class="tableBox">
        <el-table
          ...
          <el-table-column
            ...
            width="120">
            <template slot-scope="scope">
              <el-button type="text" v-show="isButtonAuthor('d3f9400da9d5425780dc2c900c9fee2a')" @click.stop="openDetailDialog(scope.row.id)">编辑</el-button>
              <el-button type="text" v-show="isButtonAuthor('efc42ea5422d4a2e891c2eadf10348bf')" @click.stop="openDeleteDialog(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
      ...
      self
        ...
        .then(response => {
          ...
          if (data.status.code == 200) {
            ...
            self.form.noticeType = companyNotice.noticeType;
            this.$refs.UEditor.resetUEContent(companyNotice.content);
          }
        })
        .catch(error => {
          self.loading.submit = false;
    ...
    resetForm() {
      ...
      this.$refs.UEditor.resetUEContent("");
    },
    ...
    save() {
      ...
      self.form.content = this.$refs.UEditor.getUEContent().trim();
        ...
        .axios({
          ...
          data: {
            ...
            params:{
              ...
              titleLikeName:self.seachForm.titleLikeName
            }
          }
        })
        .then(response => {

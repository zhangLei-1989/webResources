      ...
      <ele>
        <div class="box">
          ...
          <div class="chosen guide white"
               style="width:100%;animation: fade-in 0.5s 0s normal;">正在出借
          </div>
        </div>
      </ele>
    </group>
    <group>
      <prod-card style="animation: fade-in 1s 0s normal;"
                 class="guide"
                 :user-icon=""
                 :name="'洪泉'"
                 :apply-num="10"
                 ...
                 :repay-type="'等额本息'"
                 :service-rate="12"
                 :service-fee="10"></prod-card>
      <div class="guide-line"
           style="animation: fade-in 2s 0s normal;">
        <div class="dot"></div>
      </div>
      <div class="guide guide-txt"
           style="animation: fade-in 3s 0s normal;">
        <div>方案三：申请出借</div>
        <div>出借人设置了固定额度,时长,利息的出借,您可以直接申请</div>
      </div>
      <div v-if="usual === '1'"
           class="guide"
           @click="back"
           style="winth:100%;height:200px;animation: fade-in 3s 0s normal;">
...
<style rel="stylesheet/scss"
  ...
  .footer {
    ...
    .box {
      ...
      .bid {
        z-index: 12;
        background-image: url("../../assets/bidGuide.svg");
      }
      .iou {

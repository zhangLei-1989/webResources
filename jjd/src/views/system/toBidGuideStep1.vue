<template>
  <div class="full">
    ...
    <group>
      ...
      <!--animation: leftToRight1 1s linear 2s 1 normal;-->
      <div class="guide guide-txt"
           style="animation: fade-in 2s 0s normal;">
        <div>方案一：求借款</div>
        <div>1.设置金额、时长、利息等</div>
        <div>2.发送给指定好友或公开求借款</div>
      </div>
      <div class="guide"
           @click="go('toBidGuideStep2')"
  ...
  .guide {
    ...
    &-line {
      ...
      .dot {
        ...
        /*background: radial-gradient(rgba(255,255,255,1), rgba(255,255,255,.7));*/
        background: #fff;

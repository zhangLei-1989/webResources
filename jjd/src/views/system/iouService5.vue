<template>
  <div>
    ...
    <section>
      ...
      <table v-if="payWay == '等额本息'">
        ...
        <tr v-for="item in List">
          ...
          <td>{{item.n_amt + item.n_interest_amt}}元({{digitUppercase(item.n_amt + item.n_interest_amts)}})</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <div>
        （2）如借款人自还款日后第15日22:00前未足额偿还本金、利息和罚息的，借款人应在基础逾期管理费之外再按“截至宽限期之日后第16日未偿还借款本金、利息、罚息与基础逾期管理费之和×5%”的标准向人人信支付特别逾期管理费；如借款人自还款日后第29日22:00前未足额偿还本金、利息和罚息的，特别逾期管理费的金额调整为“截至宽限期之日后第30日未偿还借款本金、利息、罚息与基础逾期管理费之和×10%”。
      </div>
      <div class="no-indent">
